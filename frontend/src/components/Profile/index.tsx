...
// @ts-ignore
import CV_BR from '../../assets/GustavoAndradeGuimaraes_CV_BR.pdf';
// @ts-ignore
import CV_EN from '../../assets/GustavoAndradeGuimaraes_CV_EN.pdf';
    ...
    <Container>
      ...
      >
        ...
        <SocialArea>
          ...
          <SocialColumn>
            <SocialLink
              href='mailto:oi@gustaandrade.com'
              target='_blank'
              rel='noopener noreferrer'
              onClick={() => {
                ReactGA.outboundLink(
            ...
            <SocialLink
              href={i18n.language === Language.br ? CV_BR : CV_EN}
              target='_blank'
              rel='noopener noreferrer'
              onClick={() => {
                ReactGA.outboundLink(

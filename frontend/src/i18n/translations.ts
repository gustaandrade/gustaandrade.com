const Translations = {
  br: {
    translation: {
      ...
      FirstProject:
        "<p>Um plugin para o cliente REST Insomnia que gera para o usuário valores randômicos e válidos de CNPJ, pontuados ou não.</p><p>Esse pacote NPM é público e pode ser instalado usando o comando <code>npm install insomnia-plugin-random-cnpj</code> na pasta de plugins do Insomnia.</p>",
      SecondProject:
      ...
      FourthProject:
        "<p>Esse portfólio novo em versão web foi feito usando React e TypeScript.</p><p>Entre os pacotes utilizados no desenvolvimento estão <code>styled-components</code> para a troca de paletas, <code>I18Next</code> para a internacionalização e <code>Interweave</code> para interpretar textos HTML.</p>",
      FifthProject:
  ...
  en: {
    translation: {
      ...
      FirstProject:
        "<p>A plugin for Insomnia client that generates random and valid CNPJ values, punctuated or not.</p><p>This public NPM package can be installed using the command <code>npm install insomnia-plugin-random-cnpj</code> on your Insomnia plugin folder.</p>",
      SecondProject:
      ...
      FourthProject:
        "<p>This new portfolio was made using React and TypeScript.</p><p>Among the packages used in the development are <code>styled-components</code> for changing palettes, <code>I18Next</code> for internationalization and <code>Interweave</code> for interpreting HTML texts.</p>",
      FifthProject:

const Translations = {
  br: {
    translation: {
      ...
      FirstProject:
        "Um plugin para o cliente REST Insomnia que gera para o usuário valores randômicos e válidos de CNPJ, pontuados ou não.\n\nEsse pacote NPM é público e pode ser instalado usando o comando npm install insomnia-plugin-random-cnpj na pasta de plugins do Insomnia.",
      SecondProject:
      ...
      SixthProject:
        "Star Picross é um jogo em desenvolvimento na engine Unity, usando C#, para dispositivos Android e iOS.\n\nAjude a pequena estrela que caiu do céu a reencontrar o seu caminho de volta pra casa, resolvendo diversos puzzles do tipo picross.",
      Language: "Idioma",
      PaletteDescription:
  ...
  en: {
    translation: {
      ...
      FirstProject:
        "A plugin for Insomnia client that generates random and valid CNPJ values, punctuated or not.\n\nThis public NPM package can be installed using the command npm install insomnia-plugin-random-cnpj on your Insomnia plugin folder.",
      SecondProject:
      ...
      SixthProject:
        "Star Picross is a game under development on the Unity engine, using C#, for Android and iOS devices.\n\nHelp the little star that fell from the sky to find his way back home, solving various picross-type puzzles.",
      Language: "Language",
      PaletteDescription:
